Human Ideas:
    ...
    AI Incorporation:
        ...
        - An AI chatbot that allows the user to talk about each answer choice for each question--why something is wrong/right, can have the student walk through how they got an incorrect answer to suggest fixes to the logic
            - I like this one
